  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 relative overflow-hidden">
      ...
      <div className="relative bg-white p-8 rounded-2xl shadow-xl w-full max-w-lg transform transition-all duration-500 hover:shadow-2xl z-10">
        ...
        <h1 className="text-3xl font-bold text-center text-gray-800 mb-8 relative z-20">Sign In to Your Account</h1>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-6 relative z-20">
          ...
          <div className="flex justify-end">
            <a href="/forgot-password" className="text-sm text-blue-500 hover:text-blue-700 transition-colors duration-200 cursor-pointer relative z-20">
              Forgot Password?
            </a>
          </div>
          <button
        ...
        <p className="mt-6 text-center text-gray-600 relative z-20">
          ...
          <a href="/register" className="text-blue-500 hover:text-blue-700 font-medium transition-colors duration-200 cursor-pointer">
            Register
          </a>
        </p>
      </div>
